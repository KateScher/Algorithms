...
public class ConstantTimeExample {
  ...
  public static void main(String[] args) {
    ...
    // O(1), так как для доступа к элементу массива по индексу не требуется
    // просматривать другие элементы.
 ...
 * // так как нам просто нужно взять остаток от деления числа на 2, без учета
 * его размера.
